...
class BackTop extends React.Component {
    constructor(props) {
        super(props);
        this.clientHeight = document.getElementById("#root").clientHeight;
    ...
    render() {
        const show = this.state.show;
        return (
            <div className="xd-backTop" style={{position:"fixed",bottom:"20px",right:"40px",width:"100px",height:"20px",background:"red"}}>
                {show &&
